...
class GetAreasDictionaryUseCase @Inject constructor(private val repository: ApiRepository) {
    operator fun invoke(): Flow<Resource<AreasDTO>> = flow {
        try{
            val result = repository.getAreasResume()
